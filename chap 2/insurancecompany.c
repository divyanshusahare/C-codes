...
int main()
{
	char health,location,gender,e,E,c,C,M,F;
	int age;
	float policy_amout,premium;
	
	printf("Enter the health(Exellent/Poor)");
	health = getch();
	printf("enter the costumer age");
	scanf("%d",&age);
	printf("enter the location city/village");
	location = getch();
	printf("enter the gender");
	gender = getch();

	
	if((health=e||health=E)&&(age>=25&&age<=35)&&(location=c||location=C)&&(gender=='M'||gender=='F'))
    {
		printf("DEar costumer ypu are eligible for insurance");
	...
	else if(health=='e'||health=='E'&&age>=23&&age<=35&&(location=='c'||location=='C'&&gender=='M'||gender=='F')
	{
	...
	else if(health=='e'||health=='E'&&age>=23&&age<=35&&location=='c'||location=='v'&&gender=='M'||gender=='F')
	{
		printf("DEar costumer ypu are eligible foe insurance");
